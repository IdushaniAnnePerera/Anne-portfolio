    ...
    >
        ...
        <div className="relative flex items-center justify-center" style={{ width: 180, height: 180 }}>
          ...
          >
            ...
            <circle
              ...
              style={{ transition: 'stroke-dashoffset 0.05s linear', filter: 'drop-shadow(0 0 8px rgba(249,115,22,0.6))' }}
            />
            <defs>
          ...
          <motion.span
            ...
            style={{
              color: '#ffffff',
              textShadow: '0 0 24px rgba(249,115,22,0.6), 0 0 48px rgba(249,115,22,0.3), 0 2px 8px rgba(0,0,0,0.9)',
            }}
        ...
        >
          <span
            ...
            style={{
              ...
              textShadow: '0 0 16px rgba(249,115,22,0.4), 0 2px 6px rgba(0,0,0,0.8)',
            }}
          >
            ARUN_OS v4.0
          </span>
      ...
      <div className="absolute top-0 left-0 w-full h-[2px] bg-transparent z-10">
        <motion.div
          className="h-full"
          style={{
            background: 'linear-gradient(90deg, #f97316, #737373, #f97316)',

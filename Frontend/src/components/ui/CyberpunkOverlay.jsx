...
const CyberpunkOverlay = () => {
  return (
    <div className="hidden md:block fixed inset-0 pointer-events-none z-40 select-none overflow-hidden">
      ...
      {/* System Status Text */}
      <div className="absolute top-4 left-4 md:top-8 md:left-8 font-mono text-[10px] md:text-xs text-orange-300/50 tracking-widest opacity-50">
        SYSTEM_STATUS: ONLINE
        <br />
        SECURE_CONNECTION: ESTABLISHED
      </div>

      <div className="hidden md:absolute bottom-24 right-6 md:bottom-10 md:right-10 text-[10px] font-mono text-gray-300/40 tracking-widest md:block">
        RENDER_ENGINE: ACTIVE
        <br />
        <span className="text-orange-300/40 animate-pulse hidden md:inline-block">

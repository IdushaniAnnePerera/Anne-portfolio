  ...
  return (
    <div className="fixed inset-0 z-[-10] bg-black">
      <Canvas camera={{ position: [0, 0, 1] }} dpr={[1, 1.5]}>
        ...
        <FloatingShape position={[-4, 2, -5]} color="#737373" speed={1} type="torus" />
        <FloatingShape position={[4, -2, -5]} color="#f97316" speed={0.8} type="icosahedron" />
        <FloatingShape position={[0, 3, -8]} color="#a3a3a3" speed={0.5} type="icosahedron" />
      </Canvas>
    </div>
  );
};

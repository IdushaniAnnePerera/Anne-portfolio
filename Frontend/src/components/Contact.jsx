  ...
  return (
    <Section id="contact" className="ml-8 md:ml-0">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-4xl font-bold mb-8 bg-gradient-to-r from-orange-400 to-gray-400 bg-clip-text text-transparent">
          Get in Touch
        </h2>
        ...
        <a
          href={`mailto:${profile.email}`}
          className="inline-block px-8 py-4 bg-gradient-to-r from-orange-600 to-gray-700 rounded-full text-white font-bold text-lg hover:scale-105 transition-transform shadow-lg shadow-orange-500/25"
        >
          Say Hello
        </a>
      </div>
